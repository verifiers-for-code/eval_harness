...
class CheckpointHandler(FileSystemEventHandler):
    ...
    def run_script_for_checkpoint(self, parent_dir, checkpoint_name, checkpoint_num, checkpoint_suffix):
        ...
        subdir_name = f"{parent_dir}_phi3_mini_a64_{rank}_{checkpoint_name}_planner"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Monitor directory for new checkpoints and process them.")
